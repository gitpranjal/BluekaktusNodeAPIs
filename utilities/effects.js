...
async function exportCanvasAsPNG(canvasElement, fileName) {

    const buffer = canvasElement.toBuffer('image/png')
    fs.writeFileSync(path.join(__dirname, "../" ,"static", "contourImages", fileName), buffer)
}
...
// getContourImage("http://localhost:3000/static/ImageUploads/image-1602146999576.jpeg")